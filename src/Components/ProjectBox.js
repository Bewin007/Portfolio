...
const  ProjectBox = ({ projectName}) => {
  ...
  const desc = {
    Enhanced_EHR_SecurityDesc: "Developing a secure web-based EHR system using Django, Django REST Framework (DRF), React, and PostgreSQL, integrating advanced cryptographic algorithms like elliptic-curve cryptography (ECC). Conducting comprehensive security analysis focusing on data confidentiality, integrity, and authentication with ongoing simulations and real-world testing. Implementing encryption techniques to protect healthcare data, ensuring robust access control and optimizing system performance.",
    Enhanced_EHR_SecurityGithub: "",
    Enhanced_EHR_SecurityWebsite: "",
  
    AptitutorDesc: "Developed an aptitude training platform that leverages AI to generate and provide shortcut methods for solving problems. Worked on the web server part using Django, Django REST Framework (DRF), React, PostgreSQL, and Docker for deployment. Implemented a robust backend and efficient frontend to ensure seamless user experience and high performance.",
    AptitutorGithub: "",
    AptitutorWebsite: "",
    ...
    Sentiment_AnalysisDesc: "Developed a comprehensive system for extracting and analyzing audio transcripts from videos, involving speech-to-text conversion, sentiment analysis of the audio, and aggregation of YouTube comments for sentiment evaluation. Utilized Django and Django REST Framework (DRF) for robust backend development, coupled with React JS and Chakra UI for creating a responsive and user-friendly front-end interface.",
    Sentiment_AnalysisGithub: "",
    Sentiment_AnalysisWebsite: "",
    ...
    DNS_Filtering_ServiceDesc: "Developed a DNS Filtering Service using Threat Intelligence feeds and AI/ML techniques, achieving high accuracy rates in threat identification. 🔒 Implemented backend infrastructure including PCAP analysis, Zeek analysis, log parsing, and regex blocking mechanisms for network traffic analysis. Designed an intuitive frontend interface powered by Grafana to visualize network traffic and threat insights.",
    DNS_Filtering_ServiceGithub: "",
    DNS_Filtering_ServiceWebsite: "",
    ...
    Hardware_Forensic_SuiteDesc: "A Portable, Virtualized Intel NUC (Next Unit of Computing) device with the following features: Memory Forensics, Disk Forensics, Network Forensics, Multi-operating system support (Windows, Linux), User-friendly Tool Launcher Interface to launch a comprehensive set of forensic tools on each OS platform for investigation.",
    Hardware_Forensic_SuiteGithub: "",
    Hardware_Forensic_SuiteWebsite: "",
  
    Idea_BankDesc: "Designed and developed the Idea Bank application to facilitate idea sharing and collaboration. 💡 Tech stack used: React for frontend development, PostgreSQL for the database, and Django Rest Framework (DRF) for backend operations.",
    Idea_BankGithub: "",
    Idea_BankWebsite: "",
